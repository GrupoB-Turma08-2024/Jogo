...
public class TelaSenha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        telaLogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/telaSenha_1.jpg"))); // NOI18N
        telaLogin.setMaximumSize(new java.awt.Dimension(1000, 562));
        telaLogin.setMinimumSize(new java.awt.Dimension(1000, 562));
        telaLogin.setPreferredSize(new java.awt.Dimension(1000, 562));
